...
HD_PWD='/home/bzhao30/ENGS128/Lab4/hw/hw.runs/design_1_BRAM_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_BRAM_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_BRAM_wrapper_0_0.tcl
