...
HD_PWD='/home/bzhao30/ENGS128/Lab4/hw/hw.runs/clk_wiz_01_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_01.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_01.tcl
