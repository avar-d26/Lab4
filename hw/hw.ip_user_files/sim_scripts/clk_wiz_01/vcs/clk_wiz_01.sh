...
#
# Script generated by Vivado on Tue May 20 15:13:16 EDT 2025
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : clk_wiz_01.sh
...
#
# Usage        : clk_wiz_01.sh
#                clk_wiz_01.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_wiz_01.sh [-reset_run]
#                clk_wiz_01.sh [-reset_log]
#                clk_wiz_01.sh [-help]
#
...
#                script (type 'clk_wiz_01.sh -help' for more information).
#
...
# script info
echo -e "clk_wiz_01.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_wiz_01.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" +incdir+"/opt/xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" +incdir+"/opt/xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" +incdir+"/opt/xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clk_wiz_01 xil_defaultlib.glbl -o clk_wiz_01_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clk_wiz_01_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bzhao30/ENGS128/Lab4/hw/hw.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key clk_wiz_01_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk_wiz_01_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_wiz_01.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_wiz_01.sh [-help]\n\
Usage: clk_wiz_01.sh [-step]\n\
Usage: clk_wiz_01.sh [-lib_map_path]\n\
Usage: clk_wiz_01.sh [-reset_run]\n\
Usage: clk_wiz_01.sh [-reset_log]\n\
Usage: clk_wiz_01.sh [-keep_index]\n\
Usage: clk_wiz_01.sh [-noclean_files]\n\n\
